...
public class CDVBaiduMobStatistics extends CordovaPlugin {
    ...
    private void command(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        if ("onEvent".equals(action)) {
            ...
            StatService.onEvent(cordova.getActivity(), eventId, label);
            ...
            StatService.onEvent(cordova.getActivity(), eventId, label, 1, attributes);
            ...
            StatService.onEventDuration(cordova.getActivity(), eventId, label, duration);
            ...
            StatService.onEventDuration(cordova.getActivity(), eventId, label, duration, attributes);
            ...
            StatService.onEventStart(cordova.getActivity(), eventId, label);
            ...
            StatService.onEventEnd(cordova.getActivity(), eventId, label);
            ...
            StatService.onEventEnd(cordova.getActivity(), eventId, label, attributes);
